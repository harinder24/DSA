...
public class SeprateChainingTest {
    
    @Test
    public void put_Test(){  // Test to check put method...... also checks get and size method
        DictionaryInterface<String,Integer> dict = new SeparateChaining<>(6);
        dict.put("one", 1);
        dict.put("two", 2);
        dict.put("three", 3);
    ...
    @Test
    public void small_dict_size_test(){ // test to check if dictionary works on small size
        DictionaryInterface<String,Integer> dict = new SeparateChaining<>(2);
        dict.put("one", 1);
        dict.put("two", 2);
        dict.put("three", 3);
        dict.put("four", 4);
        ...
        assertEquals(new Integer(2), dict.get("five"));
    }
